      ...
      <div class="card">
        <div class="card-header text-uppercase">
          <div class="row justify-content-between">
            <div class="col">
              <i class="fas fa-file-contract"></i> Approve
            </div>
            <div class="col text-right">
              <a href="training_approved.php">Approved <i class="fas fa-arrow-alt-circle-right"></i></a>
            </div>
          </div>
        </div>
...
WHERE (ReqInfo.ReqType = 4) AND (ReqInfo.UpdateBy = '$SesUserID') AND (ReqInfo.Status = 3)
ORDER BY ReqInfo.ReqNo";
            ...
            <div class="card-footer border-light bg-white cart-panel-foo-fix">
              <div class="d-flex mt-3">
                ...
                <div class="mr-1"><button type="submit" name="SubmitCheckedGroup" value="1" class="btn btn-success" onclick="return BttSubmitCheck();"><i class="fa fa-check-circle"></i> Approve</button></div>
...
<form id="frmrequest" name="frmrequest" class="form" action="save/save_approve_list.php" autocomplete="off" method="POST" target="iframe_check_Reqlist">
  <div class="modal fade ModalCheckOTList" tabindex="-1" role="dialog" aria-labelledby="reque_title" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header text-greenblue">
          <h5 class="modal-title" id="reque_title">Approve</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        ...
        -->
          ...
          <button type="submit" name="SubmitCheckedList" value="1" class="btn btn-success" onclick="return BttSubmitCheckList();"><i class="fa fa-check-circle"></i>&nbsp; Approve</button>
...
<script type="text/javascript">
  $('#ModalSuccess').on('hidden.bs.modal', function() {
    window.location.href = 'training_approve.php';
