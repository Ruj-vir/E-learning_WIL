                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        ?>
                                <li class="list-group-item careers border rounded">
                                    <div onclick="location.href='training_register_card_detail.php?ItemReqNo=<?php echo $ListResult['ReqNo']; ?>&j0dsu36gpd9gsu9sdj9'">
                                        <div class="row">
                        ...
                        ?>
                                            ...
                                            <div class="col-lg-2 mb-2">
                                                <button type="button" class="btn btn-greenblue btn-sm btn-block" onclick="location.href='training_register_card_detail.php?ItemReqNo=<?php echo $ListResult['ReqNo']; ?>&j0dsu36gpd9gsu9sdj9'"><span class="mr-2">Let's go</span><i class="fas fa-arrow-right"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </li>
