        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-2">
              ...
              <ul class="mb-2">
                ...
                <li>Trainees Total: <strong class="mr-3"><?php print $ListIRow; ?></strong>
          ...
          <div class="form-group">
              <button type="button" class="btn btn-dark btn-block btn-lg" data-toggle="modal" data-target="#AttachmentModal"><i class="fas fa-paperclip"></i> View files</button>
                ...
                ?>
                  <form id="formAttach" name="formAttach" action="save/save_attach_user_training.php" enctype="multipart/form-data" autocomplete="off" method="POST" target="iframe_upload_file">
                ...
                ?>
                <form id="formRegister" name="formRegister" action="save/save_register_user_training.php" autocomplete="off" method="POST" target="iframe_register_form">
          ...
          <div class="form-group">
            ...
            ?>
              <form action="save/save_attachtext_user_training.php" autocomplete="off" method="POST" target="iframe_upload_text">
