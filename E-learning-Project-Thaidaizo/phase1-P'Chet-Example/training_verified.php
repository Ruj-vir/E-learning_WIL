      ...
      <div class="card shadow">
        <div class="card-header text-uppercase">
          <div class="row justify-content-between">
            <div class="col">
              <i class="fas fa-file-alt"></i> verified
            </div>
            <div class="col text-right">
              <a href="training_verify.php">Verify <i class="fas fa-arrow-alt-circle-right"></i></a>
            </div>
          </div>
        </div>
          ...
          <div id="FineLeaveDate">
            <div class="hidden-scroll-y custom-scrollbar">
              <div class="blog-card">
                ...
                AND (dbo.ReqInfo.ReqApproveDate IS NOT NULL)
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header text-greenblue">
        <h5 class="modal-title" id="reque_title">Verified</h5>
      ...
      <div class="modal-body">
        ...
        <input type="hidden" id="txtNoDetail" name="txtNoDetail" readonly>
...
<script type="text/javascript">
  $(document).ready(function() {
    $('.BttLookModalChecked').click(function() {
      ...
      if (Item_ReqNo != '') {
        $.ajax({
          url: "return/return_verified.php",
          method: "POST",
          data: {
  ...
  $(document).ready(function() {
    $('.DateStart, .DateEnd').on('keyup change', function() {
      ...
      if (((DateFrom != "" && DateTo != "") && (DateFrom <= DateTo))) { //alert(DateTo);
        $.ajax({
          url: "return/return_searchverified.php",
          method: "POST",
          data: {
            DateFrom: DateFrom,
            DateTo: DateTo
