      ...
      <div class="card shadow my-4">
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-sm-6 mb-2">
              Object: <span class="font-weight-bold h6"><?php $EleData = explode('|', $ListResult["UserDefine1"]);
                                                        print $EleData[1]; ?></span>
            </div>
            <div class="col-sm-6 mb-2">
          ...
          <form id="RegisterForm" name="RegisterForm" action="save/save_register_card_training.php" autocomplete="off" method="POST" target="iframe_register">
            <div class="form-group row">
              <label for="InputRFID" class="col-sm-3 col-form-label">Register card:</label>
              <div class="col-sm-9">
...
//     var elem = document.getElementById('InputRFID').value;
//     if (!elem.match(/^([a-z0-9])+$/i)) {
//       //onblur="CheckLanguage();"
...
// });
	...
	$(document).ready(function () {
	  $('#InputRFID').keypress(function (e) {
			...
			e.preventDefault();
      alert("You can only enter numbers and English characters.");
			return false;
		});
	});
