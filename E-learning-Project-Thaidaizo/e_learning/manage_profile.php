...
?>
      <div class="row">
		  <div class="col-lg-4">
			<img class="img-fluid rounded mx-auto" style="width: 100%; height: 200px; background: #eceff1; border: solid 3px #eceff1;" src="../img/photo_emp/rectangle/<?php echo ($result["EmpUserID"] != NULL) ? $result["EmpUserID"] : '10000';?>.jpg" alt="Images">	
		  </div>
          <div class="col-lg-8">
            <div class="row">
              <div class="col-lg-12 my-2"><b>ID:</b> <?php echo $result["EmpUserID"]; ?></div>
              <div class="col-lg-6 my-2"><b>Name:</b> <?php echo $result["EmpUserName"]; ?></div>
              <div class="col-lg-6 my-2"><b>Surname:</b> <?php echo $result["EmpUserSurname"]; ?></div>
              <div class="col-lg-6 my-2"><b>Position:</b> <?php echo $result["EmpUserPosition"]; ?></div>
              <div class="col-lg-6 my-2"><b>Section:</b> <?php echo $result["EmpUserSection"]; ?></div>
              <div class="col-lg-6 my-2"><b>Department:</b> <?php echo $result["EmpUserDepartment"]; ?></div>
              <div class="col-lg-6 my-2"><b>Email:</b> <?php echo $result["EmpUserEmail"]; ?></div>
              <div class="col-lg-6 my-2"><b>Status:</b> 
              <span class="badge badge-pill badge-dark">
			  <?php 
				switch ($result["Authentication"]){
				case 1: echo "Requestor"; break;
				case 2: echo "Inspector"; break;
				case 3: echo "Approvers"; break;
				case 6: echo "Verify"; break;
        case 9: echo "IT"; break;
        default: echo 'None';
				}
			  ?>
              </span>
				  ...
				  <div class="tab-content" id="nav-tabContent">
					<div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                      <ul class="list-group list-group-flush my-3">
                        ...
                        <li class="list-group-item">
                        <div class="d-flex align-items-center">
                          <img class="rounded-circle border border-secondary mr-2" src="../img/photo_emp/square/<?php echo ($objResult24["EmpUserID"] != NULL) ? $objResult24["EmpUserID"] : '10000';?>.jpg" alt="Images" width="48" height="48">
                            <div class="lh-100">
                              <div><?php echo ($objResult24["EmpUserID"] != NULL) ? $objResult24["EmpUserID"] : 'none';?>&nbsp;: <span class="badge badge-pill badge-dark" style="width: 60px;">Verify</span></div>
                              <div class="font-weight-bold"><?php echo $objResult24["EmpUserName"]."\n". $objResult24["EmpUserSurname"];?></div>
                          </div>
                        </div>
                        </li>
                        <li class="list-group-item">
                        <div class="d-flex align-items-center">
                          <img class="rounded-circle border border-secondary mr-2" src="../img/photo_emp/square/<?php echo ($objResult25["EmpUserID"] != NULL) ? $objResult25["EmpUserID"] : '10000';?>.jpg" alt="Images" width="48" height="48">
                            <div class="lh-100">
                              <div><?php echo ($objResult25["EmpUserID"] != NULL) ? $objResult25["EmpUserID"] : 'none';?>&nbsp;: <span class="badge badge-pill badge-dark" style="width: 60px;">Approve</span></div>
                              <div class="font-weight-bold"><?php echo $objResult25["EmpUserName"]."\n". $objResult25["EmpUserSurname"];?></div>
                          </div>
                        </div>
                        </li>
                        ...
                        <div class="text-center">
                          <button type="button" class="btn btn-dark w-25 Amodal" data-id="<?php echo $objResult22["LvApprove"] ;?>" data-App="<?php echo $objResult22["EduVerify"] ;?>" data-Verify="<?php echo $objResult22["EduApprove"];?>"><i class="fa fa-edit"></i>&nbsp; Edit</button>
                        </div>
					</div>
...
<div class="row my-3">
 <div class="col-lg-4 mb-4">
   ...
   <div class="row justify-content-between">
    ...
    <div class="col-6 text-right">
      <span class="h5 font-weight-bold text-greenblue"><?php echo $result11["CountID"];?></span>
    </div>
  </div>
  ...
  <div class="table-responsive">
   <div class="table-wrapper-scroll-y my-custom-scrollbar">
	<table class="table table-hover text-truncate" style="width:100%">
	  ...
	  ?>
		<tr>
		  <th scope="row"><?php echo $result02["EmpUserID"];?></th>
		  <td><?php echo $result02["EmpUserName"]."\n".$result02["EmpUserSurname"];?></td>
		  <td><?php echo $result02["EmpUserPosition"];?></td>
		  <td><?php echo $result02["EmpUserSection"];?></td>
		  <td><a href="save/save_remove_user.php?txtEmpUserID=<?php echo $result02["EmpUserID"];?>&txtFlow=Check&txtAuthor=<?php echo $result["EmpUserID"];?>" onclick="return confirm('Are you sure you want to Remove?');" class="btn btn-dark btn-sm"><i class="fa fa-times-circle"></i></a></td>
		</tr>
	  <?php }} ?>
	  </tbody>
	</table>
 ...
 <div class="row justify-content-between">
  ...
  <div class="col-6 text-right">
    <span class="h5 font-weight-bold text-greenblue"><?php echo $result10["CountID"];?></span>
  </div>
</div>
...
<table class="table table-hover text-truncate" style="width:100%">
 ...
 <div class="col-lg-4 mb-4">
   <div class="row justify-content-between">
    ...
    <div class="col-6 text-right">
      <span class="h5 font-weight-bold text-greenblue"><?php echo $result09["CountID"];?></span>
    </div>
  </div>
  <div class="table-responsive">
   <div class="table-wrapper-scroll-y my-custom-scrollbar">
<table class="table table-hover" style="width:100%">
  ...
  ?>
    <tr>
      <th scope="row"><?php echo $result03["EmpUserID"];?></th>
      <td class="text-truncate"><?php echo $result03["EmpUserName"]."\n".$result03["EmpUserSurname"];?></td>
      <td class="text-truncate"><?php echo $result03["EmpUserPosition"];?></td>
      <td class="text-truncate"><?php echo $result03["EmpUserSection"];?></td>
	  <td><a href="save/save_remove_user.php?txtEmpUserID=<?php echo $result03["EmpUserID"];?>&txtFlow=Approve&txtAuthor=<?php echo $result["EmpUserID"];?>" onclick="return confirm('Are you sure you want to Remove?');" class="btn btn-dark btn-sm"><i class="fa fa-times-circle"></i></td>
    </tr>
  <?php }} ?>
  </tbody>
</table>
...
<div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
  ...
  <form class="mt-3" id="frmChange" name="frmChange" action="save/save_change_authen.php" autocomplete="off" method="POST" target="iframe_transfer">
	<input type="hidden" value="<?php echo $result["EmpUserID"];?>" id="txtEmpCurrent" name="txtEmpCurrent" readonly>
  ...
  <script type="text/javascript">
      function ResultUpdateRelated(UpdateRelated) {
          if(UpdateRelated == 1) {
            ...
            setInterval('window.location.href = "manage_profile.php?Empedit=<?php echo $EmployeeID ;?>"', 1000);
