		...
		<div class="card-header">
		  <div class="d-flex">
			<div class="h3 mr-auto">
			  <strong>Generate <span class="badge badge-primary">TDP</span></strong>
		  	</div>
...
WHERE (LEN(dbo.Cnt_Quota.EmpID) = 5) AND (CarBookingSystem.dbo.VREmpBus.Plant = 'TDP')
...
<script type="text/javascript">
	function CanteenResult(Generate) {
      if(Generate == 1) {
        ...
        setInterval('window.location.href = "canteen_generate_tdp.php"', 1000);
      }else {
