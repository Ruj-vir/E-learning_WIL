	...
	<div class="container">
	  <div class="card">
		<div class="card-header h3">
		  <strong>Confirm <span class="badge badge-warning">TDA</span></strong>
		</div>
		<div class="card-body">
				...
				<div class="ConfirmResult"></div>
						 ...
						 <div class="table-responsive">
						  <table id="CanteenConfirm" class="table table-hover nowrap" style="width:100%">
							...
							FROM dbo.Cnt_TrnDetail INNER JOIN HRSystem.dbo.eEmployee ON dbo.Cnt_TrnDetail.EmpID = HRSystem.dbo.eEmployee.sEmpID WHERE (dbo.Cnt_TrnDetail.Status = 1) AND (dbo.Cnt_TrnDetail.MakeBy = 'Canteen TDA')";
							...
							<?php }
							$stmt00 = "SELECT SUM(Qta_Value) AS total FROM Cnt_TrnDetail WHERE (Status = 1) AND (MakeBy = 'Canteen TDA')";
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header border-0">
        <h5 class="modal-title text-green" id="ConfirmTitle">Add transaction <span class="badge badge-warning">TDA</span></h5>
		...
		<form action="save/save_add_transaction.php" autocomplete="off" method="POST" target="iframe_add_transaction">
		  ...
		  <div class="ConfirmResult"></div>
			...
			<div class="modal-footer border-0">
				<button type="submit" name="addlisttda" class="btn btn-green w-25" onclick="return BttAdd();">Save</button>
			</div>
		</form>
    </div>
  </div>
