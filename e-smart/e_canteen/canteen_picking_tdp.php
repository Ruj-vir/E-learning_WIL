	  ...
	  <div class="card shadow-sm">
	      <div class="card-header">
			...
			<div class="mr-auto h3">
				<strong>Picking <span class="badge badge-primary">TDP</span></strong>
			</div>
				<div><button type="button" class="btn btn-green" onClick="window.location='canteen-picking.TV.TDP.php';"><i class="fas fa-tv"></i></button></div>
			</div>
		  </div>

<div class="card-body">
 <form action="save/save_picking_main.php" autocomplete="off" method="POST" target="iframe_picking">
 <input type="hidden" class="form-control" id="CanteenPlan" name="CanteenPlan" value="Canteen TDP" required>
...
$(function(){
    setInterval(function(){ // เขียนฟังก์ชัน javascript ให้ทำงานทุก ๆ 30 วินาที
        ...
        var getData = $.ajax({ // ใช้ ajax ด้วย jQuery ดึงข้อมูลจากฐานข้อมูล
                url:"return/return_pinking_main_TDP.php",
                data:"Receive=1",
                async:false,
