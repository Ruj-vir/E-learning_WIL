	...
	<div class="container">
	  <div class="card">
		<div class="card-header h3">
		  <strong>MONTHLY <span class="badge badge-warning">TDA</span></strong>
		</div>
		<div class="card-body">
...
HAVING (dbo.Cnt_TrnDetail.Status = 3) AND (dbo.Cnt_TrnDetail.MakeBy = 'Canteen TDA') AND (dbo.Cnt_TrnDetail.TrnDate = '".$date."')";
  ...
  <script src="assets/js/Ex.calculator.tableMonth.js"></script>
	...
	<script type="text/javascript">
		$(document).ready(function(){
	      ...
	      if((From != '' && to != '') && (From <= to)) {
	        $.ajax({
	          url:"return/return_reportmonth_tda.php",
	          method:"POST",
