		...
		<div class="card-header">
		  <div class="d-flex">
			<div class="h3 mr-auto">
			  <strong>Generate <span class="badge badge-warning">TDA</span></strong>
		  	</div>
	...
	<form action="save/save_generate.php" autocomplete="off" method="POST" target="iframe_generate_many">
		<div class="table-responsive mt-3">
		   <table id="TableGen" class="table table-hover text-truncate nowrap" style="width:100%">
			 ...
			 <tbody class="tbody">
			 <?php
$stmt = "SELECT LEN(dbo.Cnt_Quota.EmpID) AS LenName, dbo.Cnt_Quota.EmpID, HRSystem.dbo.eEmployee.sEmpFirstName, HRSystem.dbo.eEmployee.sEmpLastName,
HRSystem.dbo.eEmployee.sEmpEngFirstName, HRSystem.dbo.eEmployee.sEmpEngLastName, dbo.Cnt_Quota.Qta_Date, dbo.Cnt_Quota.UserDefine1, CarBookingSystem.dbo.VREmpBus.Plant,
dbo.Cnt_Quota.Qta_Qty, dbo.Cnt_Quota.Qta_Value
FROM dbo.Cnt_Quota
INNER JOIN HRSystem.dbo.eEmployee ON dbo.Cnt_Quota.EmpID = HRSystem.dbo.eEmployee.sEmpID
INNER JOIN CarBookingSystem.dbo.VREmpBus ON dbo.Cnt_Quota.EmpID = CarBookingSystem.dbo.VREmpBus.EmpCode
WHERE (LEN(dbo.Cnt_Quota.EmpID) = 5) AND (CarBookingSystem.dbo.VREmpBus.Plant = 'TDA')
...
<script type="text/javascript">
	function CanteenResult(Generate) {
      if(Generate == 1) {
        ...
        setInterval('window.location.href = "canteen_generate_tda.php"', 1000);
      }else {
