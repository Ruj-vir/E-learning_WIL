...
<?php
	...
	dbo.Cnt_TrnDetail.Status = 1) AND (dbo.Cnt_TrnDetail.TrnDate = '$Datelimit') AND (dbo.Cnt_TrnDetail.MakeBy = 'Canteen TDA')
...
?>
        ...
        <div class="card-body">
		  <small>ID:</small>
          <h5 class="card-title"><?php echo $obResult["EmpID"] ;?></h5>
		  <small>Name(TH):</small>
          <h5 class="card-title text-uppercase"><?php echo $obResult["sEmpFirstName"] ;?></h5>
		  <small>Name(EN):</small>
          <h5 class="card-title text-uppercase"><?php echo $obResult["sEmpEngFirstName"] ;?></h5>
