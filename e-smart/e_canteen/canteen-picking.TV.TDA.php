...
<body translate="no">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-6"><h1 class="font-weight-bold text-warning">CANTEEN PICKING <span class="badge badge-warning">TDA</span></h1></div>
      <div class="col-lg-6">
        ...
        <form class="blackID1" id="frmMain" name="frmMain" action="save/checktime.php" autocomplete="off" method="POST" target="iframe_target">
        ...
        <input type="hidden" id="plant" name="plant" value="Canteen TDA" required readonly />
        </form>
      </div>
    </div>
  </div>
  ...
  $(function(){
      setInterval(function(){ // เขียนฟังก์ชัน javascript ให้ทำงานทุก ๆ 30 วินาที
          ...
          var getData = $.ajax({ // ใช้ ajax ด้วย jQuery ดึงข้อมูลจากฐานข้อมูล
                  url:"return/return_pinking_tv_TDA.php",
                  data:"Receive=1",
                  async:false,
  ...
  $(function(){$('#txtRFID').bind('change keyup',function(){
    ...
    // การทำ curcer ค้างไว้ๆ 
    $(window).load(function(){
		$(document).ready(function() {
      // #txtRFID อันนี้คือ ตัวรับ ไอดี
