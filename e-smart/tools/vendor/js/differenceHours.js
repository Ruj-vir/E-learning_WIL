    ...
    this.diff_hours = function (time1, time2, result) {
        ...
        let minute;
            ...
            if (parseInt(vars.second_hour_split[1]) < parseInt(vars.first_hour_split[1])) {
                ...
                vars.$el.text(final_hours + '.' + final_min)    
            }
...
/*
            if (parseInt(vars.second_hour_split[1]) < parseInt(vars.first_hour_split[1])) {
                ...
                if (hours < 10) {
                    final_hours = '' + hours;       //final_hours = '0' + hours;
                } else {
                    final_hours = hours;
                }

                if (minute < 10) {
                    final_min = '0' + minute;       final_min = '0' + minute;
                } else {
                    final_min = minute;
                }

                vars.$el.text(final_hours + '.' + final_min)    //vars.$el.text(final_hours + 'H' + final_min)
            }
*/
/*
            if (parseInt(vars.second_hour_split[1]) === parseInt(vars.first_hour_split[1])) {
