        ...
        <div class="card-header text-uppercase">
          <div class="row justify-content-between">
            ...
            <div class="col text-right">
              <a href="#">Checked <i class="fas fa-arrow-alt-circle-right"></i></a>
            </div>
          </div>
        </div>

        <div class="card-body">
          <form id="formCheck" name="formCheck" class="form" action="save/save_check_group.php" autocomplete="off" method="POST" target="iframe_check_ReqGroup">
...
WHERE (ReqInfo.ReqType = 4) AND (ReqInfo.ReqChecker = '$SesUserID') AND (ReqInfo.Status = 1)
...
<!-- Modal Check -->
<form id="frmrequest" name="frmrequest" class="form" action="save/save_check_list.php" autocomplete="off" method="POST" target="iframe_check_Reqlist">
