                ...
                <div class="card my-4">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="inputCourse" name="inputCourse" placeholder="Enter Course name" required>
                                </div>
                                <div class="form-group">
                                    <label for="inputObject">Object :</label>
                                    <textarea class="form-control" id="inputObject" name="inputObject" rows="3" maxlength="100" required placeholder="Enter Objective"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="inputOrganizer">Organizer :</label>
                                    <input type="text" class="form-control" id="inputOrganizer" name="inputOrganizer" maxlength="50" placeholder="Enter Organizer name" required>
                                </div>

                                <div class="form-row">
                                    <div class="form-group col">
                                        <label for="inputDateFrom">From date :</label>
                                        <input type="date" class="form-control" id="inputDateFrom" name="inputDateFrom" value="<?php echo date('Y-m-d', strtotime('+0 day')); ?>" required placeholder="">
                                    </div>
                                    <div class="form-group col">
                                        <label for="inputDateTo">To date :</label>
                                        <input type="date" class="form-control" id="inputDateTo" name="inputDateTo" value="<?php echo date('Y-m-d', strtotime('+0 day')); ?>" required placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        <input type="time" class="form-control" min="06:00" max="18:00" id="inputTimeFrom" name="inputTimeFrom" value="<?php echo date('H:i'); ?>" required placeholder="">
                                    </div>
                                    <div class="form-group col">
                                        <label for="inputTimeTo">To time :</label>
                                        <input type="time" class="form-control" min="06:00" max="18:00" id="inputTimeTo" name="inputTimeTo" value="" required placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        <input type="number" required class="form-control" id="inputDurationDay" name="inputDurationDay" placeholder="" require>
                                    </div>
                                    <div class="form-group col">
                                        <label for="inputDurationTime">Duration Hour :</label>
                                        <input type="number" class="form-control" required id="inputDurationTime" name="inputDurationTime" placeholder="" require>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-6">
                                        ...
                                        <input type="number" required class="form-control" id="inputCost" name="inputCost" placeholder="THB" require>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="Attach1 boxhide">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="inputImgFile" name="inputImgFile" accept=".jpg, .jpeg">
                                            <label class="custom-file-label" for="inputImgFile">Choose .JPG</label>
                                        </div>
                                    </div>
                                    <div class="Attach2 boxhide">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="inputPdfFile" name="inputPdfFile" accept="application/pdf">
                    ...
                    <div class="card-footer">
                        <div class="float-right">
                            ...
                            <button type="button" class="btn btn-danger" onclick="return BttReset();"><i class="fa fa-times-circle"></i> Cancel</button>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    function BttSubmit() {
        ...
        if ((document.getElementById("inputTrainees") == "")) {
            alert("Please attach an image file.");
