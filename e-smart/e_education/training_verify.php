  ...
  <div class="row mt-4">
    <div class="col-xl-12 col-md-6 mb-4">
      <div class="card">
        ...
        <div class="card-body">
          <form id="formCheck" name="formCheck" class="form" action="save/save_verify_group.php" autocomplete="off" method="POST" target="iframe_check_Reqlist">
...
WHERE (ReqInfo.ReqType = 4) AND (ReqInfo.ReqChecker = '$SesUserID') AND (ReqInfo.Status = 2)
ORDER BY ReqInfo.ReqNo";
            ...
            <div class="card-footer border-light bg-white cart-panel-foo-fix">
              <div class="d-flex mt-3">
                ...
                <div class="mr-1"><button type="submit" name="SubmitVerifyGroup" value="1" class="btn btn-success" onclick="return BttSubmitCheck();"><i class="fa fa-check-circle"></i> Check</button></div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        -->
          ...
          <button type="submit" name="SubmitVerifyList" value="1" class="btn btn-success" onclick="return BttSubmitCheckList();"><i class="fa fa-check-circle"></i>&nbsp; Check</button>
          ...
          <div class="modal fade" id="Cancel_list" tabindex="-1" role="dialog" aria-labelledby="Status_title" aria-hidden="true">
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <button type="submit" name="RejectVerifyList" value="3" class="btn btn-dark" onclick="return Bttlist();">Confirm</button>
                </div>
              </div>
            </div>
          </div>
