...
<?php
	...
	$stmt10 = "SELECT DISTINCT UpdateBy FROM ReqInfo WHERE (ReqNo=$ItemID) AND (ReqApprover='$SesUserID') AND (Status=4)";
	...
	WHERE (ReqNo = $ItemID) AND (Status = 4)";
	...
	<br/>
		...
		<table style='width: 100%;'cellspacing='0' cellpadding='0'>
		   ...
		   $Queryer12 = "SELECT EmployeeID FROM ReqInfo WHERE (ReqNo=$ItemID) AND (ReqApprover='$SesUserID') AND (UpdateBy='".$result10["UpdateBy"]."') AND (Status=4)";
