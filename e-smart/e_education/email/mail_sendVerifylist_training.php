...
<?php
	...
	<br/>
		...
		<table style='width: 100%;'cellspacing='0' cellpadding='0'>
		   ...
		   if($obj){
		   $stmt00 = "SELECT EmployeeID FROM ReqInfo WHERE (ReqNo=$EmpReq) AND (ReqApprover='".$result02["ReqApprover"]."') AND (ReqApprover='$SesUserID') AND (ReqType = 4) AND (ReqFleg = 'C1') AND (Status = 3)";
