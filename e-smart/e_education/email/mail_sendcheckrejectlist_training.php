...
<?php
	...
	<br/>
		...
		<table style='width: 100%;'cellspacing='0' cellpadding='0'>
		   ...
		   if($obj){
            $Queryer6 = "SELECT EmployeeID FROM ReqInfo WHERE(ReqNo=$EmpReq) AND (ReqChecker = '$SesUserID') AND (ReqIssuer = '".$objResulty12["ReqIssuer"]."') AND (ReqType = 4) AND (ReqFleg = 'C1') AND (Status = 0)";
