...
<td width="50%" style="text-align: right;">
    <div>Request No.</div>
    <div><strong>' . $ListResult["ReqNo"] . '</strong></div>
</td>
</tr>
</table>
...
<tr>
    ...
    <td>'.date_format($ListResult["ReqDate"], 'H:i') . " - " . date_format($ListResult["TrnTime"], 'H:i').'</td>
</tr>
<tr>
...
<tr>
    ...
    <input type="radio" name="TypeTraining" value="3" '.(($ListResult["TrainRecType"] == 3) ? 'checked="checked"' : "").' > Refreshing &nbsp;&nbsp;&nbsp;
    <input type="radio" name="TypeTraining" value="4" '.(($ListResult["TrainRecType"] == 4) ? 'checked="checked"' : "").' > On Going &nbsp;&nbsp;&nbsp;
